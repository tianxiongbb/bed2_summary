...
fun_plot_scatter2=function(x, y, n1, n2, m){
	...
	if(length(cl)<2000){
		...
		points(i1,i2,pch=20,col=densCols(i1,i2,colramp=colorRampPalette(c("#a50f15","#fff5f0"))))
	}
...
if(1){
	...
	pdf(paste(pre,"_vs_",sn2,".",appendix,".scatter.pdf", sep=""), width=8, height=4, useDingbats=F)
	par(mfrow=c(1,2),tcl=0.3,bty="n")
